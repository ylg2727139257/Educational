...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form class="form-x" method="post" onsubmit="return checkUser()" action="${pageContext.request.contextPath }/insertCourse.action">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select class="input w50" name="tid">
          	<option value="0">  请  选  择  教  师  </option>
          	<c:forEach items="${ACTEACHER }" var="item">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="credit" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="number" class="input w50" name="cmax" />
        </div>
      </div>
      <div class="field">
...
/* -----  submit  */
	...
	var tid=document.getElementsByName("tid")[0];	
