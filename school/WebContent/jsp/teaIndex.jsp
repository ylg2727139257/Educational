...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="teaInfo.jsp" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
    <li><a href="teaModify.jsp" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
    <li><a href="${pageContext.request.contextPath }/teaCourse.action" target="right"><span class="icon-caret-right"></span>课程信息</a></li>
  </ul>   
</div>
